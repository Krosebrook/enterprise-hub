...
export default function ServiceCard({ 
  ...
  return (
    ...
    >
      {/* Title Bar */}
      <div className={`${languageColors[service.language] || 'bg-slate-500'} text-white px-4 py-2 rounded-t-md flex items-center justify-between`}>
      ...
      <div className="p-4 space-y-2">
        <div className="flex items-center justify-between text-sm">
          ...
          <span className="font-medium">{languageLabels[service.language] || service.language}</span>
        </div>
        ...
        <div className="flex items-center justify-between text-sm pt-2 border-t border-slate-100">
          ...
          <div className="flex items-center gap-2">
            <div className={`w-2 h-2 rounded-full ${healthColors[service.health_status] || healthColors.unknown}`} />
