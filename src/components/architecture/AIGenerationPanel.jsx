            ...
            <Card className="bg-green-50 border-green-200">
              <CardContent className="p-4">
                <div className="space-y-2">
                  ...
                  {generateMutation.data?.data?.catalog_items_used > 0 && (
                    <p className="text-xs text-green-700 pl-8">
                      ♻️ Reused {generateMutation.data.data.catalog_items_used} catalog items
                    </p>
                  )}
                  {generateMutation.data?.data?.generated_code && (
                    <p className="text-xs text-green-700 pl-8">
                      📝 Generated OpenAPI docs, CRUD operations, and unit tests
                    </p>
                  )}
                </div>
              </CardContent>
