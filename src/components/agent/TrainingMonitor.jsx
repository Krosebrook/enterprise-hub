          ...
          <CardContent className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="bg-white rounded-lg p-3">
                ...
                <div className="text-sm font-medium">{estimateTimeRemaining(activeJob)}</div>
              </div>
            </div>
            ...
            return (
              ...
              >
                <div className="flex items-center gap-3 flex-1">
                  <StatusIcon
                    className={`w-4 h-4 ${statusConfig[job.status].animate ? "animate-spin" : ""} ${
                ...
                {job.status === "completed" && job.accuracy_after && (
                  <div className="flex items-center gap-1 text-xs">
                    ...
                    <span className="font-medium text-green-700">{job.accuracy_after}%</span>
                  </div>
                )}
