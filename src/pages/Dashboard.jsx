...
import { GitBranch, Bot, Shield, Plus, Sparkles, FileBarChart, ArrowRight } from "lucide-react";
...
export default function Dashboard() {
  ...
  const avgComplianceScore =
    enabledFrameworks.length > 0
      ? Math.round(
          enabledFrameworks.reduce((sum, f) => sum + (f.compliance_score || 0), 0) /
            enabledFrameworks.length
        )
      : 0;

  return (
    <div className="p-6 lg:p-8 max-w-7xl mx-auto" data-b44-sync="page-dashboard">
      {/* Header */}
      <div className="mb-8">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-slate-500 mt-1">Here's what's happening with your organization</p>
          </div>
          {user?.role && (
      ...
      {/* Metrics Grid */}
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8" data-b44-sync="metrics-grid">
        <MetricCard
